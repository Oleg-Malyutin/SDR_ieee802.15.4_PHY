...
#include "../mac_sublayer/mac_sublayer.h"

class phy_layer : public phy_layer_callback, plme_sap_callback
{
public:
    phy_layer();
    ~phy_layer();

    oqpsk_demodulator *demodulator;
    oqpsk_modulator *modulator;
    mac_sublayer *mac;
...
private:
    ...
    phy_mode event_mode = RX;
    bool event_ready = false;
    std::condition_variable event;
    std::mutex event_mutex;
    bool start_on = true;
    void work();
    void callback_stop_phy_layer();
    void stop();
