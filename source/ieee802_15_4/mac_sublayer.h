...
typedef struct mac_sublayer_data {
    bool is_started;
    bool ready;
    bool stop;
    ...
    ~mac_sublayer_data(){mpdu = nullptr;};
} mac_sublayer_data_t;
enum frame_type{
    Frame_type_beacon=0,
    Frame_type_data,
...
class mpdu_sublayer_callback
{
public:
    virtual void mpdu_callback(mpdu mpdu_)=0;
};
...
public:
    ...
    void connect_callback(mpdu_sublayer_callback *cb_){callback = cb_;};

private:
    mpdu_sublayer_callback *callback;
