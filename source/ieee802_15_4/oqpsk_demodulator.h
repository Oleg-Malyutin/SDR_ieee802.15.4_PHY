...
public:
    ...
    void start(rx_thread_data_t *rx_thread_data_, rx_sap_t *rx_sap_);
...
private:
    ...
    float local_zz_imag[len_local + OVERSAMPLE * 2];
...
//    float local_real[16 * LEN_CHIP];
//    float local_imag[16 * LEN_CHIP];
